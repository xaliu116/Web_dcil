...
def load_models():
    ...
    decoder.load_state_dict(torch.load('./AesUST/models/decoder.pth'))
    transform.load_state_dict(torch.load('./AesUST/models/transformer.pth'))
    vgg.load_state_dict(torch.load('./AesUST/models/vgg_normalised.pth'))
    discriminator.load_state_dict(torch.load('./AesUST/models/discriminator.pth'))
